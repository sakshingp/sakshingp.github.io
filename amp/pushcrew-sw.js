'use strict';
var _wingifyPush = {
    hash: '24bea2fb1747789fe7b14a87445f9628',
    trackingUrl: 'https://tracking.pushcrew.com',
    pcDomainUrl: 'https://pushcrew.com',
    defaultIcon: 'https://cdn.pushcrewstaging.com/img/logos/766af0552c1778152d69a686aabd8ab1/81b8f6f4-25c7-4e96-8e80-cef8fa8843fc.png',
    origin: 'https',
    isAMPEnabled: 1,
    vapidPublicKey: 'BOj4rQWv6KqUvHdrHfpvGjxUzjW2WIBYpdSJmEhXUkJ_tutRQ3CA_kkzDReqxgvtfCpF2kizMzEkZFcVNQFl7DY'
}
  ...
  jstz = function() {
    ...
    var amp = {
      ...
      generateSyncSubscriptionParameters: function(subscription, action) {
        ...
        'unsubscribe-ui' === action && (this.subscriberId = ''), this.makeQueryString(tslib_1.__assign({
    ...
    return amp;
  }(0, detectBrowser, tslib, AMPCommandEnum), function(jstz, IndexedDb, detectBrowser, amp) {
